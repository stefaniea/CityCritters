 ...
 // 	var pets = petApiData.petfinder.pets.pet; 
	...
	$.each(pets.pet, function(idx, obj) {
		//for(var i = 0; i < obj.length; i++) {
			...
			var dataDescription = (obj.description.$t).substring(0, 200) + "...";//obj[i].description.$t;
			...
			link.setAttribute("data-largesrc", imgSrc);
			img.setAttribute("style", "padding: 10px");
			//link.setAttribute("class", "md-trigger");
			...
			//link.setAttribute("href", "#" + obj.id.$t);
